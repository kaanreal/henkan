      ...
      <main className="flex-1">
        ...
        <section className="max-w-3xl mx-auto px-4 sm:px-6 pb-16">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-3">
            ...
            <Link to="/docs#batch-conversion" className="henkan-button px-6 py-3 rounded-xl bg-surface-800 border border-surface-700/40 text-surface-300 font-medium text-sm text-center hover:bg-surface-700 hover:text-surface-100 transition-colors">
              {t('siteHeader.docs')}
            </Link>
          </div>
        </section>
