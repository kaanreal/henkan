...
export const parse_sm_difficulty: (a: number, b: number, c: number) => [number, number, number, number];
export const rate_label_text: (a: number) => [number, number];
export const scale_timing_for_rate: (a: number, b: number, c: number) => [number, number, number, number];
